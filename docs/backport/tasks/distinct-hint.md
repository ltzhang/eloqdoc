...
- [x] Explain plan shows the hinted index used.
...
- Runtime and explain-shape coverage is in `tests/jstests/eloq_basic/distinct_hint.js`.

No remaining work in this parser/planner slice.
